...
#define DEFAULT_TRIS            (SK | DO | CS | GPIO0 | GPIO1 | GPIO3)  /* SK/DO/CS and GPIOs are outputs, DI is an input */
#define DEFAULT_PORT            (SK | CS | GPIO0 | GPIO1 | GPIO3)       	/* SK and CS are high, all others low */
